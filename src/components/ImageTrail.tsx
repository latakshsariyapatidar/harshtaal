...
class ImageTrailVariant1 {
  ...
  constructor(container: HTMLDivElement) {
    ...
    const initRender = (ev: MouseEvent | TouchEvent) => {
      ...
      target.removeEventListener('mousemove', initRender as EventListener);
      target.removeEventListener('touchmove', initRender as EventListener);
    };
    target.addEventListener('mousemove', initRender as EventListener);
    target.addEventListener('touchmove', initRender as EventListener);
  }
...
export default function ImageTrail({ items = [], variant = 1, size = 60 }: ImageTrailProps): JSX.Element {
