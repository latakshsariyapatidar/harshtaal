...
export function Footer() {
  return (
    <footer className="bg-[#0a0a0a] border-t border-white/5 py-16 px-6 text-stone-400">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-stone-400 text-sm leading-relaxed mb-4 font-light" style={{ fontFamily: "'Noto Sans JP', sans-serif" }}>
              A celebration of art, culture, and minimalist design — held at the permanent campus of IIT Dharwad.
            </p>
            <p className="text-stone-600 text-xs" style={{ fontFamily: "'Noto Sans JP', sans-serif" }}>ハーシュタル</p>
          </div>
          ...
          <div>
            <p className="text-[#c62828] tracking-widest uppercase text-xs mb-4 font-medium" style={{ fontFamily: "'Noto Sans JP', sans-serif" }}>Contact</p>
            <ul className="space-y-3 text-stone-400 text-sm font-light" style={{ fontFamily: "'Noto Sans JP', sans-serif" }}>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-stone-500 text-xs font-light" style={{ fontFamily: "'Noto Sans JP', sans-serif" }}>
